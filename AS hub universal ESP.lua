...
boxStroke.Parent = boxFrame  
	...
	-- 2. Name ESP Frame (Dioptimalkan posisinya menggunakan Scale)
	...
	-- 3. Side Vertical Health ESP Bar Background (FIXED: Sekarang terlihat jelas!)
...
-- 4. Health Bar Dynamic Fill (Bottom up calculation)  
